...
def getHybridFusionDataset(cls):
    class HybridFusionDataset(cls):
        """
        This dataset is used for early fusion, where each CAV transmit the raw
        point cloud to the ego vehicle.
        """
        def __init__(self, params, visualize, train=True):
            super(HybridFusionDataset, self).__init__(params, visualize, train)
            print("initialize hybrid fusion dataset")
        ...
        def __getitem__(self, idx):
            ...
            for cav_id, selected_cav_base in base_data_dict.items():
                ...
                #print("in dataloader",lidar_dict['voxel_coords'].shape)
                ...
                processed_data_dict[cav_id].update(
                ...
                if self.visualize:
                    processed_data_dict[cav_id].update({'origin_lidar':
                                                        projected_lidar_stack})
        ...
        def get_item_single_car_no_project(self, selected_cav_base):
            """
            Project the lidar and bbx to ego space first, and then do clipping.
        ...
        def collate_batch_test(self, batch):
            ...
            #output_dict['hybrid'].update({'points_num':batch['hybrid']['points_num']})
            return output_dict
