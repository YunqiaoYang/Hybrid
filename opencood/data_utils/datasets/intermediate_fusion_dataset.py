    ...
    class IntermediateFusionDataset(cls):
        ...
        def __getitem__(self, idx):
            ...
            for _i, cav_id in enumerate(cav_id_list):
                ...
                # if cav_id!=ego_id:
                #         lidar=selected_cav_base['lidar_np']
                ...
                #         else:
                #             lidar=lidar[0:0]
                #         selected_cav_base['lidar_np']=lidar
                #         points_num+=selected_cav_base['lidar_np'].shape[0]
            ...
            if self.load_lidar_file:
                ...
                # print(merged_feature_dict.shape)
                # print(merged_feature_dict)
            if self.load_camera_file:
        ...
        def collate_batch_train(self, batch):
            ...
            for i in range(len(batch)):
                ...
                if self.visualize:
                    ...
                    ego_lidar = [ego_dict['ego_lidar']]
                    if(ego_dict['only_ego']==False):
                        collaboration_lidar = [ego_dict['collaboration_lidar']]
            ...
            if self.visualize:
                ...
                output_dict['ego'].update({'ego_lidar': ego_lidar})
                if(ego_dict['only_ego']==False):
                    collaboration_lidar = \
                        np.array(
                    ...
                    output_dict['ego'].update({'collaboration_lidar': collaboration_lidar})
                else:
                    output_dict['ego'].update({'collaboration_lidar': None})
                output_dict['ego'].update({'only_ego': ego_dict['only_ego']})
        ...
        def collate_batch_test(self, batch):
            ...
            # print(batch['ego']['points_num'])
            output_dict['ego'].update({'points_num':batch[0]['ego']['points_num']})
