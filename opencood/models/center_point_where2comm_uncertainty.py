...
class CenterPointWhere2commUncertainty(nn.Module):
    def __init__(self, args):
        super(CenterPointWhere2commUncertainty, self).__init__()
        print("center_point_uncertainty_model")
        # PIllar VFE
        ...
        self.reg_head = nn.Conv2d(self.out_channel, 8 * args['anchor_number'],
                                  kernel_size=1)
        self.unc_head = nn.Conv2d(self.out_channel, 2 * args['anchor_number'],
                                  kernel_size=1)
    ...
    def forward(self, data_dict):
        ...
        unc_preds_single = self.unc_head(spatial_features_2d)
        ...
        unc_preds = self.unc_head(fused_feature)
        ...
        output_dict.update({'cls_preds_single': psm_single,
                       ...
                       'unc_preds_single': unc_preds_single
                       })
        return output_dict
